...
//Pager Adapter. Loads the fragment Mall.
public class ViewPagerAdapterMall extends FragmentStatePagerAdapter {
    ...
    public ViewPagerAdapterMall(FragmentManager fm) {
        super(fm);
