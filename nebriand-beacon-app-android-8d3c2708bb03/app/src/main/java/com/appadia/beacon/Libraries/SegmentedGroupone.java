package com.appadia.beacon.Libraries;
...
public class SegmentedGroupone extends RadioGroup {

    private int mMarginDp;
    private Resources resources;
    private int mTintColor,UncheckedTextcolor;
    private int mCheckedTextColor = Color.WHITE;
    private int bordercolor;
    private LayoutSelector mLayoutSelector;
    private Float mCornerRadius;

    public SegmentedGroupone(Context context) {
        super(context);
        resources = getResources();
        mTintColor = resources.getColor(R.color.red);
        bordercolor = resources.getColor(R.color.red);
    ...
    public SegmentedGroupone(Context context, AttributeSet attrs) {
        super(context, attrs);
        resources = getResources();
        mTintColor = resources.getColor(R.color.red);
        UncheckedTextcolor= resources.getColor(R.color.red);
        mMarginDp = (int) getResources().getDimension(R.dimen.radio_button_stroke_border);
        mCornerRadius = getResources().getDimension(R.dimen.radio_button_conner_radius);
        initAttrs(attrs);
        mLayoutSelector = new LayoutSelector(mCornerRadius);
    ...
    private void updateBackground(View view) {
       ...
       ColorStateList colorStateList = new ColorStateList(new int[][]{
                ...
                {-android.R.attr.state_pressed, android.R.attr.state_checked}},
                new int[]{Color.GRAY, UncheckedTextcolor, mCheckedTextColor});
      /*  try {
            XmlResourceParser parser = getResources().getXml(R.color.Actionbar_bac);
       ...
       // ((GradientDrawable) checkedDrawable).setColor(mTintColor);
        ((GradientDrawable) checkedDrawable).setColor(UncheckedTextcolor);
        ((GradientDrawable) checkedDrawable).setStroke(mMarginDp, bordercolor);
        ((GradientDrawable) uncheckedDrawable).setStroke(mMarginDp, bordercolor);
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return SegmentedGroupone.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return SegmentedGroupone.this.indexOfChild(view);
        }
